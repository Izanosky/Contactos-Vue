<template>
  <div>
    ...
    <Form v-if="contacto" v-slot="$form" :initialValues="estadoInicial" :resolver="resolver" @submit="onFormSubmit"
...
const estadoInicial = ref({
  nombre: contacto.value ? contacto.value.nombre : '',
  email: contacto.value ? contacto.value.email : '',
  telefono: contacto.value ? contacto.value.telefono : '',
  empresa: contacto.value ? contacto.value.empresa : '',
  estado: contacto.value ? contacto.value.estado : '',
  favorito: contacto.value ? contacto.value.favorito : false
})
...
const onFormSubmit = ({ valid, values }) => {
  if (valid && contacto.value) {
    ...
    router.push({ name: 'contacto-detalle', params: { id: contactoID.value } })
  }
}
</script>